...
%section~\ref{sec:poc_architecture} gives an overview of the system architecture
...
\begin{figure*}
\begin{center}
%\includegraphics[width=140mm]{img/prototype/Drawing18.png}
\includegraphics[width=140mm]{img/prototype/architecture.png}
...
\begin{figure*}
\begin{center}
\includegraphics[width=100mm]{img/prototype/inverted-index_building_2_bis.png}
...
%\subsection{Emulation of gossip protocol}
%has been emulated by a superpeer
