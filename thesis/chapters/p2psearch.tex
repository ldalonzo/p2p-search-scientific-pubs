...
\includegraphics[width=64mm]{img/p2psearch/napster_publish.png}
\label{fig:napster_A}
}
\hspace{4mm}
...
\includegraphics[width=64mm]{img/p2psearch/napster_query.png}
...
\begin{figure*}
\begin{center}
\includegraphics[width=100mm]{img/p2psearch/gnutella_query_6.png}
...
\begin{algorithm}[t]
\caption{Cyclon and Vicinity epidepic protocols skeleton}%\cite{VS05, VSI06}
\begin{algorithmic}[1]
