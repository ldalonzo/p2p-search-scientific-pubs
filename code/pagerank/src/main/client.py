...
class Indexer(threading.Thread):
    ...
    def __init__(self, index, name='indexer'):
        ...
        #self.__directoryToIndexList.append('../dataset')
        self.__directoryToIndexList.append('/home/leo/workspace/bibliography/thesis')
        #self.__directoryToIndexList.append('../testbed')
    ...
    def run(self):
        ...
        try:
            ...
            for directory in self.__directoryToIndexList:
                ...
                #the citation graph is built only at the end
            
            self.__index.buildCitationsLinks()
            #self.__index.buildCitationsLinks_andSample()
            #adjacencyMatrix = self.__index.buildAdjacencyMatrix()
            self.__index.createDotCode()
            #self.__index.calculatePageRank()
            #self.__index.submitPDF_DEBUG()#LEAVME PLEASE!!!!!!
                #self.__index.buildCitationsLinks()#REMOVE
